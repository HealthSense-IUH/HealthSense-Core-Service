# Health Record Module Database Migration

## Tiếng Việt

- **Quy tắc đặt tên:** `V<YYYYMMDDHHMMSS>__<mo_ta_ngan_gon>.sql` (Ví dụ: `V20260823190000__create_health_records_table.sql`).
...
- **Naming Convention:** `V<YYYYMMDDHHMMSS>__<short_description>.sql` (e.g. `V20260823190000__create_health_records_table.sql`).
