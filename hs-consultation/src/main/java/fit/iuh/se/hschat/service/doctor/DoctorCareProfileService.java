...
public interface DoctorCareProfileService {
    ...
    DoctorCareProfileResponse getOwnProfile(Long doctorId);

    DoctorCareProfileResponse updateOwnAvailability(Long doctorId, UpdateDoctorAvailabilityRequest request);
}
